...
function HeroDiv() {
  ...
  <div className="w-full xl:w-1/4  md:pl-24 lg:pl-28 xl:pl-36 md:py-16 lg:py-16 xl:py-28 bg-white z-2">
  ...
  <h1 className="text-3xl md:text-4xl lg:text-6xl xl:text-8xl font-bold text-center md:text-left" style={{ whiteSpace: 'nowrap' }}>is Now</h1>
    ...
    <div className="py-4">
      <p className='text-center md:text-sm md:text-left '>
        <span className="text-transparent sm:text-sm md:text-xs lg:text-xl  bg-clip-text mb-1 font-semibold bg-gradient-to-r from-lime-500 to-sky-500">MAKUENI VALLEY FARM </span>
  ...
  <button className="space-x-4 flex items-center gap-x-2">
    Products <FaLongArrowAltRight />
  </button>
</div>
  </div>
  <div
    className="w-full md:w-3/4 rounded-2xl mt-4 lg:mt-0"
    style={{
