...
function Contact() {
  ...
  <form onSubmit={sendEmail} ref={form} className="animate__animated animate__slideInRight max-w-md bg-white mx-auto p-4 md:p-6 rounded-md shadow-xl">
    ...
    <button
      type="submit"
      className="w-full bg-lime-400 text-black py-2 px-4 rounded-md hover:bg-lime-600"
    >
      Submit
    </button>
  </form>
	...
	<h2 className='text-3xl text-center font-medium py-8 bg-lime-400'>Farm Location</h2>
